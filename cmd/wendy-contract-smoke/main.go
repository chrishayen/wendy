...
import (
	...
	"wendy/internal/distributedsmoke"
	"wendy/internal/openapicheck"
	"wendy/internal/processsmoke"
...
func run(args []string, stdout, stderr io.Writer, httpClient *http.Client) int {
	flags := flag.NewFlagSet("wendy-contract-smoke", flag.ContinueOnError)
	...
	processDistributed := flags.Bool("process-distributed", false, "run a process-level distributed smoke suite with real Wendy commands")
