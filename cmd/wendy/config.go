...
const (
	defaultConfigPath  = "wendy.yaml"
	defaultStateDir    = ".wendy/state"
	defaultArtifactDir = ".wendy/artifacts"
)
...
func generateToken() (string, error) {
	...
	return "wendy_" + base64.RawURLEncoding.EncodeToString(raw), nil
}
...
func ensureGeneratedIgnore(dir string) error {
	...
	text := string(raw)
	entries := []string{"wendy.yaml", ".wendy/"}
