...
import (
	...
	"wendy/internal/provider/browsersearch"
)
...
func main() {
	...
	allowedHosts := flag.String("allowed-hosts", envOrDefault("WENDY_BROWSER_ALLOWED_HOSTS", "localhost,127.0.0.1,::1"), "comma-separated allowed browser hosts; use * only for trusted deployments")
